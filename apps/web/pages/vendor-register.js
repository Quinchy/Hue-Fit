...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"; // Added shadcn select
...
export default function PartnershipForm() {
  ...
  const handleOtpSubmit = async () => {
    ...
    try {
      ...
      const createResponse = await axios.post("/api/partnership/create-vendor-account", formDataToSend, {
      ...
      setOtpError("An error occurred during account creation. Please try again.");
    } finally {
      setOtpLoading(false);
    }
  };
          ...
          <div className="flex flex-col items-start gap-5 mt-20">
            ...
            <div className="relative">
              <Image
                ...
                width={900}
                height={750}
                className="rounded-md object-cover max-w-[75rem] max-h-[30rem]"
                priority
              />
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-7 p-3">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1" ref={fieldRefs.position}>
                    ...
                    >
                      <SelectTrigger className={`w-full px-5 ${InputErrorStyle(formik.errors.position, formik.touched.position)}`}>
                ...
                <p className="text-center text-primary/50 font-light text-sm">
                  ...
                  <Link href={routes.partnership} className="text-primary px-[5px] hover:underline">
                    Terms of Use
                  </Link>{" "}
                  and{" "}
                  <Link href={routes.partnership} className="text-primary px-[5px] hover:underline">
