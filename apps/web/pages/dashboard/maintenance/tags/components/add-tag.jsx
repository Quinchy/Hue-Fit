...
export default function AddTagDialog({ buttonClassName = "", buttonName = "Add Tag" }) {
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="name" className="font-bold flex flex-row items-center">Tag Name <Asterisk className="w-4"/></Label>
            <Input id="name" placeholder="Enter a tag name" />
          </div>
          <div className="flex flex-col gap-2">
        ...
        <DialogFooter>
          <Button onClick={() => console.log("Tag Added")}>
            Add
          </Button>
        </DialogFooter>
      </DialogContent>
