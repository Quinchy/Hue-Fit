...
// Import your reusable loading component here
...
export default function ViewProduct() {
  ...
  // Use the Loading component instead of the skeleton
  if (isLoading) {
    return (
  ...
  return (
    <DashboardLayoutWrapper>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-row gap-5">
                <div className="flex flex-row items-center gap-1">
                  <Label className="font-bold flex flex-row items-center">Product Number:</Label>
                  <p className="py-1 px-3 w-fit rounded text-sm bg-accent">{product.productNo}</p>
                </div>
                <div className="flex flex-row items-center gap-1">
                  <Label className="font-bold flex flex-row items-center">In Stocks:</Label>
                  <p className="py-1 px-3 w-fit rounded text-sm bg-accent">{product.totalQuantity}</p>
                </div>
              </div>
              <div className="flex flex-row gap-5">
                <div className="flex flex-row items-center gap-1">
                  <Label className="font-bold flex flex-row items-center">Type:</Label>
                  <p className="py-1 px-3 w-fit rounded text-sm bg-accent">{product.Type.name}</p>
                </div>
                <div className="flex flex-row gap-1">
                  <Label className="font-bold flex flex-row items-center">Category:</Label>
                  <p className="py-1 px-3 w-fit rounded text-sm bg-accent">{product.Category.name}</p>
                </div>
                <div className="flex flex-row gap-1">
                  <Label className="font-bold flex flex-row items-center">Tag:</Label>
                  <p className="py-1 px-3 w-fit rounded text-sm bg-accent">{product.Tag.name || "N/A"}</p>
                </div>
              </div>
              <div className="flex flex-row gap-1">
                <Label className="font-bold flex flex-row items-center">Description:</Label>
      ...
      <div className="mt-5 flex flex-col gap-3">
        ...
        <div className="flex flex-col items-start gap-3 mb-28">
