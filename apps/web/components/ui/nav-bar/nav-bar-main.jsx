      ...
      <nav className="flex flex-row items-center gap-10 uppercase">
        ...
        <div className='flex flex-row items-center gap-5'>
          <Link
            ...
            href={session ? routes.dashboard : routes.login} // Adjust href if needed
          >
            <p className="uppercase tracking-widest text-pure font-bold text-md">
              {session ? "Dashboard" : "Login"} {/* Conditionally render text */}
            </p>
          </Link>
          <ModeToggle />
        </div>
